...
{
    local hanselSDKVersion=$(/usr/libexec/PlistBuddy -c "Print :sdk_version" "${SRCROOT}/Pods/Hansel.io-ios/Hanselio/framework/Hanselio.framework/Headers/PebbletraceInfo.plist")
...
{
    local iosMinSDKVersion=$(/usr/libexec/PlistBuddy -c "Print :ios_min_sdk_version" "${SRCROOT}/Pods/Hansel.io-ios/Hanselio/framework/Hanselio.framework/Headers/PebbletraceInfo.plist")
...
{
    local iosTargetSDKVersion=$(/usr/libexec/PlistBuddy -c "Print :ios_target_sdk_version" "${SRCROOT}/Pods/Hansel.io-ios/Hanselio/framework/Hanselio.framework/Headers/PebbletraceInfo.plist")
...
{
    python Pods/Hansel.io-ios/Hanselio/lib/compile/dsymparser.py
}
